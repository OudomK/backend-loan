...
class GuarantorForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Section::make('Guarantor Profile')
                    ->description('Manage the guarantor identity, status, and contact information from one place.')
                        ...
                        Grid::make([
                            ...
                            ->schema([
                                TextInput::make('customer_code')
                                    ...
                                    ->maxLength(255)
                                    ->default(fn () => GuarantorResource::nextGuarantorCode()),
                                Select::make('status')
                                    ->label('Status')
                                    ->native(false)
                                    ->options([
