...
class ActiveLoanExcelExport
{
    public function download(array $data, Request $request, ?string $fromDateStr, ?string $toDateStr, ?string $officerName)
    {
        ...
        $reportTitle = "Active Loan Report";
        ...
        $headers = [
            ...
            'Disb. Amount', 'Currency', 'Interest Rate', 'Processing Fee', 'Monthly Interest Rate', 'Term', 'Tenor',
            'Pay. Method', 'Re-Finance', 'Restructure', 'Admin Fee', 'Refinance Fee', 'Collateral Type',
            'C.O Disburse', 'C.O Repay.', 'Outstanding', 'Principle Paid', 'Interest Paid', 'Maturity Date', 'Aging',
            'Overdue Amount', '1st Repay. Date', 'Last Pay. Date', 'Account Status', 'Account Rating', 'S/L Term',
            'Secure Loan', 'Provision'
        ];
        ...
        $keys = [
            ...
            'co_disburse', 'co_repay', 'outstanding_amount', 'principal_paid', 'interest_paid', 'maturity_date', 'aging_days',
            'overdue_amount', 'first_repayment_date', 'last_payment_date', 'account_status', 'account_rating', 'short_long_term',
            'secure_loan_type', 'provision_amount'
        ];

        $numberKeys = [
            'disbursement_amount', 'interest_rate', 'processing_fee', 'monthly_interest_rate', 'refinance_amount',
            'admin_fee', 'refinance_fee', 'outstanding_amount', 'principal_paid', 'interest_paid', 'overdue_amount', 'provision_amount'
        ];
        
        $integerKeys = [
            'term', 'aging_days', 'restructure'
        ];
        ...
        $fileName = 'Active_Loan_Report_' . date('Ymd_His') . '.xlsx';
