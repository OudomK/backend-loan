...
$currency = 'USD'; // Implies 2 decimal rounding

// 'linear_monthly' is what 'Declining' maps to in our controller
...
echo "Loan: $$principal, Duration: $duration months, Rate: $rate%\n";
echo "Method: Declining (Fixed Principal)\n\n";
